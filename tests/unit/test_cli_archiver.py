...
exercises the full Phase 4 wiring (`_bootstrap`: preflight, provider,
vault, repository, archiver) that the integration tests (which use
`FakeProvider` directly) don't touch."""
